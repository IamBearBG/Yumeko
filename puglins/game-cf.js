...
let handler = async (m, { conn, text, command, usedPrefix }) => {
    ...
    if (esGanador) {
        ...
        conn.reply(m.chat, `✧ La moneda cayó en *${text}*, acabas de ganar *1000 🍪 Galletas*`, m, rcanal)       
    } else {
        global.db.data.users[m.sender].cookies -= 500
        conn.reply(m.chat, `✧ La moneda cayó en *${text}*, acabas de perder *500 🍪 Galletas*`, m, rcanal)
    }
}

...
let yaemori = `*⭒─ׄ─ׅ─ׄ─⭒ \`\`\`Información - Yumeko\`\`\` ⭒─ׄ─ׅ─ׄ─⭒\n\n`
yaemori += `🌸 *◜Creador◞* ⇢ IamBearBG\n`
yaemori += `🍟 *◜Prefijo◞* ⇢ [ ${usedPrefix} ]\n`
yaemori += `🔄 *◜Versión◞* ⇢ ${vs}\n`
yaemori += `🌻 *◜Chats Privados◞* ⇢ ${chats.length - groupsIn.length}\n`
yaemori += `🌺 *◜Total De Chats◞* ⇢ ${chats.length}\n`
yaemori += `🍄 *◜Usuarios◞* ⇢ ${totalreg}\n`
yaemori += `🍁 *◜Chats Privados◞* ⇢ ${chats.length - groupsIn.length}\n`
yaemori += `🌴 *◜Grupos◞* ⇢ ${groupsIn.length}\n`
yaemori += `✨ *◜Actividad◞* ⇢ ${muptime}\n`
yaemori += `🚄 *◜Velocidad◞* ⇢ ${(speed * 1000).toFixed(0) / 1000}\n`
yaemori += `☁️ *◜SubBots Activos◞* ⇢ ${totalUsers || '0'}`
